...
{
    /// <inheritdoc />
    public partial class CreatingAndInitializingDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "Data Science", "Explore the basics of machine learning including supervised learning, classification, and regression.", "~/img/machine learning.jpg", 2, "Machine Learning Basics", 1800 },
                    { 5, "Data Science", "Build deep learning models using TensorFlow, focusing on neural networks and CNNs.", "~/img/tensorflow.jpg", 3, "Deep Learning with TensorFlow", 950 },
                    { 6, "Data Science", "Analyze, visualize, and manipulate data using Python's powerful Pandas library.", "~/img/pandas.png", 3, "Data Analysis with Pandas", 700 },
